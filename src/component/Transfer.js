    ...
    if (
      ...
      if (fromRegistration) {
        const updatedBalance =
          fromRegistration.myBalance - Number(transferInput.enterAmount);
    ...
    <>
      <div class="container">
        <div class="col-7">
          ...
          <div class="col-12 p-2">
            <div class="input-group mb-3 mt-2">
              ...
              <input
                type="number"
                class="form-control"
                onKeyUp={inputTransfer}
                name="enterDestinationAccount"
              />
          ...
          <div class="row">
            <button
              class="btn btn-primary mx-auto col-md-2 col-3 rounded-pill"
              onClick={transfer}
            >
              Transfer
            </button>
