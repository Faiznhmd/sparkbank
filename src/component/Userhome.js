    ...
    <>
      <div className="container">
        ...
        <div class="col-7">
          ...
          <div class="row">
            <div
              class="col text-center bg-light h6 p-5 m-2"
          ...
          <div class="row">
            <div
              class="col-6 mx-auto text-center bg-light h6 p-5 m-2"
              style={{ borderRadius: 10 }}
              id="transfer"
            >
              Invest
          ...
          <div>
            ...
            {userTransfer !== '' ? (
              userTransfer.map((history, i) => (
                <TransferHistory history={history} i={i} />
              ))
            ) : (
