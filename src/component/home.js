    ...
    <div className="container-fluid p-0 bg-light" id="body">
      <section className="Anand">
        <section id="hero" class="d-flex justify-cntent-center text-white">
          <div
            id="heroCarousel"
            class="container-fluid carousel m-0 carousel-fade p-5 text-center"
          ...
          >
            <div class="carousel-item active pt-5">
              <div class="carousel-container mt-5">
                <h2 class="">
                  Welcome to <span className="suryaa">Spark-Bank</span>
                </h2>
                <p class="animate__animated animate__fadeInUp " id="headerText">
      ...
      <section class="services">
        <div class="container mt-5">
          <div class="row">
            <div
              class="col-md-6 col-lg-3 d-flex align-items-stretch text-center"
              data-aos="fade-up"
            >
              <div class="bg-white p-3" id="myRounded">
                ...
                <h4 class="title">
                  <a href="http://localhost:3000/">Lorem Ipsum</a>
                </h4>
                <p class="description">
            ...
            >
              <div class="bg-white p-3" id="myRounded">
                ...
                <h4 class="title">
                  <a href="http://localhost:3000/">Sed ut perspiciatis</a>
                </h4>
                <p class="description">
            ...
            >
              <div class="bg-white p-3" id="myRounded">
                ...
                <h4 class="title">
                  <a href="http://localhost:3000/">Magni Dolores</a>
                </h4>
                <p class="description">
            ...
            >
              <div class="bg-white p-3" id="myRounded">
                ...
                <h4 class="title">
                  <a href="http://localhost:3000/">Nemo Enim</a>
                </h4>
                <p class="description">
      ...
      <div class="container-fluid bg-white">
        <div class="container-fluid">
          <div class="row mt-5 text-center">
            <div class="col-12 mt-3 text-muted h6">LATEST BLOG</div>
          ...
          <div class="row deck">
            <div class="col-12 col-md-6 col-lg-3 mt-5 border">
              <div class="body p-0">
                <div class="col-12">
                  <img
                    src="Pictures/inbound-marketing-banks.jpg"
                    alt=""
                    width="100%"
                  />
                </div>
                <div class="row p-2 text-center">
                  ...
                  <div>MD Segun Agbaje presents at SMW 2020</div>
                  <div class="mt-4">Watch now</div>
                </div>
              </div>
            </div>
            <div class="col-12 col-md-6 col-lg-3 mt-5 border">
              <div class="body p-0">
                <div class="col-12">
                  <img
                    src="Pictures/Oasdom-Challenges-of-Internet-Banking-In-Nigeria-e-banking.jpg"
                    alt=""
                    width="100%"
                  />
                </div>
                <div class="row p-2 text-center">
                  ...
                  <div>
                    Our forecasts and opinions on the broad Nigerian
                    macroeconomic and banking sectors trends in 2020.
                  </div>
                  <div class="mt-4">Read the report</div>
                </div>
              </div>
            </div>
            <div class="col-12 col-md-6 col-lg-3 mt-5 border">
              <div class="body p-0">
                ...
                <div class="row p-2 text-center">
                  ...
                  <div>
                    Award-winning CEO building a great African institution
